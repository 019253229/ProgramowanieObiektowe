...
int menu()
{
	...
	while(true)
    {
        ...
        case 2:
        {
            ...
            cout << "Wybierz numer wiersza w ktorym chcesz edytowac element: (od 0 do " << arr.pobierzRozmiarX()-1 << "): " << endl;

            cin >> indeksX;

            cout << "Wybierz numer kolumny w ktorej chcesz edytowac element: (od 0 do " << arr.pobierzRozmiarY()-1 << "): " << endl;
            ...
            if(arr.aktualizuj_zawartosc(arr, indeksX, indeksY, nowa_wartosc) != SUCCESS)
            {
        ...
        case 4:
        {
            ...
            cout << "Wybierz kolumne ktora chcesz zsumowac: (od 0 do " << arr.pobierzRozmiarY()-1 << "): " << endl;
        ...
        case 5:
        {
            ...
            cout << "Wybierz wiersz ktory chcesz zsumowac: (od 0 do " << arr.pobierzRozmiarX()-1 << "): " << endl;
        ...
        case 6:
        {
            ...
            if(arr.minimumX( arr, wiersz, &najmniejszaX) == SUCCESS)
            {
        ...
        case 7:
        {
            ...
            if(arr.minimumY(arr, kolumna, &najmniejszaY) == SUCCESS)
            {
        ...
        case 8:
         {
            ...
            if(arr.maximumX( arr, wiersz, &najwiekszaX) == SUCCESS)
            {
        ...
        case 9:
        {
            ...
            if(arr.maximumY( arr, kolumna, &najwiekszaY) == SUCCESS)
            {
